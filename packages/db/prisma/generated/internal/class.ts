...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "model User {\n  id                  String    @id @map(\"_id\")\n  name                String\n  email               String\n  emailVerified       Boolean\n  avatar              String?\n  profileImage        String?   @default(\"/placeholder-avatar.jpg\") // Set a default avatar image\n  bio                 String?\n  location            String?\n  userType            String? // Added for Step 1\n  individualFocus     String? // Added for Step 1\n  organizationPurpose String? // Added for Step 1\n  howHear             String? // Added for Step 2\n  howHearOther        String? // Added for Step 2 (for \"other\" option)\n  goals               String[]  @default([]) // Added for Step 3, stored as array of strings\n  skills              String[]  @default([]) // Added for Step 4, stored as array of strings\n  createdAt           DateTime\n  updatedAt           DateTime\n  sessions            Session[]\n  accounts            Account[]\n\n  @@unique([email])\n  @@map(\"user\")\n}\n\nmodel Session {\n  id        String   @id @map(\"_id\")\n  expiresAt DateTime\n  token     String\n  createdAt DateTime\n  updatedAt DateTime\n  ipAddress String?\n  userAgent String?\n  userId    String\n  user      User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([token])\n  @@map(\"session\")\n}\n\nmodel Account {\n  id                    String    @id @map(\"_id\")\n  accountId             String\n  providerId            String\n  userId                String\n  user                  User      @relation(fields: [userId], references: [id], onDelete: Cascade)\n  accessToken           String?\n  refreshToken          String?\n  idToken               String?\n  accessTokenExpiresAt  DateTime?\n  refreshTokenExpiresAt DateTime?\n  scope                 String?\n  password              String?\n  createdAt             DateTime\n  updatedAt             DateTime\n\n  @@map(\"account\")\n}\n\nmodel Verification {\n  id         String    @id @map(\"_id\")\n  identifier String\n  value      String\n  expiresAt  DateTime\n  createdAt  DateTime?\n  updatedAt  DateTime?\n\n  @@map(\"verification\")\n}\n\ngenerator client {\n  provider     = \"prisma-client\"\n  output       = \"../generated\"\n  moduleFormat = \"esm\"\n  runtime      = \"nodejs\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n",
  "inlineSchemaHash": "d9b5abad3b7ca39fb2f2d5cea51a33e7f5b1ecaff91eef7284cc3af4b6e6a7fc",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
